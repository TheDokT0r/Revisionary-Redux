...
export default function About() { 
    const copyPasta = `I fucking hate Tibby. I want to rip his tiny limbs apart as he screams in agony. I'll laugh and say "Let's we go amigo!" as I send him stright to Hell where he beongs.`;
